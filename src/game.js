...
Game.World.Player = class extends Game.World.AnimatedObject{
    ...
    updateAnimation(){
        if(this.velocity_y < 0){
            if(this.direction_x < 0) this.changeFrameSet(Game.World.Player.frame_sets["jump-left"], "pause", 2);
            else this.changeFrameSet(Game.World.Player.frame_sets["jump-right"], "pause", 2);
        }
        else if(this.direction_x < 0){
            if(this.velocity_x < -0.1) this.changeFrameSet(Game.World.Player.frame_sets["move-left"], "loop", 2);
            else this.changeFrameSet(Game.World.Player.frame_sets["idle-left"], "pause", 2);
        }
        else if(this.direction_x > 0){
            if(this.velocity_x > 0.1) this.changeFrameSet(Game.World.Player.frame_sets["move-right"], "loop", 2);
            else this.changeFrameSet(Game.World.Player.frame_sets["idle-right"], "pause", 2);
        }
